...
public class KogitoPluginTest {
    ...
    public void kogitoPluginAddsKogitoTaskToProject() {
        ...
        assertInstanceOf(ProcessClassesTask.class, project.getTasksByName(PROCESS_CLASSES_TASK, false).iterator().next());
        assertInstanceOf(KogitoCompileTask.class, project.getTasksByName(KOGITO_COMPILE_TASK, false).iterator().next());
    }
}